  ...
  return (
    <div className="bg-gray-800 min-h-screen text-gray-800 flex flex-col items-center py-10 overflow-x-hidden">
      ...
      <div className="w-full max-w-screen-md mx-auto px-4 sm:px-6">
        ...
        {/* Who I Am */}
        <div className="bg-gray-900 p-4 sm:p-6 rounded-lg shadow-lg mb-8
          ...
          <p className="text-white mt-2 leading-relaxed">
            ...
            continuously developing my HR knowledge and skills to contribute
            effectively to both employees and organizational growth.
          </p>
        </div>
...
<div className="bg-gray-800 p-4 rounded-lg shadow-md
  ...
  <p className="text-white text-center break-words">
    <strong>HR Metrics:</strong> Tracking and analyzing recruitment,
    attendance, employee turnover, and workforce data.
  </p>
</div>
...
<div className="bg-gray-800 p-4 rounded-lg shadow-md
  ...
  <p className="text-white text-center break-words">
    <strong>Microsoft Outlook:</strong> Professional email communication,
    interview scheduling, calendar management, and HR coordination.
  </p>
</div>
...
<div className="bg-gray-800 p-4 rounded-lg shadow-md
  ...
  <p className="text-white text-center break-words">
    <strong>Microsoft PowerPoint:</strong> Creating professional HR
    presentations, reports, training materials, and management presentations.
  </p>
</div>
...
<div className="bg-gray-800 p-4 rounded-lg shadow-md
  ...
  <p className="text-white text-center break-words">
    <strong>Microsoft Word:</strong> Preparing HR documents, employee
    letters, policies, reports, and professional documentation.
  </p>
</div>
...
<div className="bg-gray-800 p-4 rounded-lg shadow-md
  ...
  <p className="text-white text-center break-words">
    <strong>Power BI:</strong> Creating HR dashboards, visualizing
    workforce data, and analyzing HR metrics and reports.
  </p>
</div>
        ...
        <div className="w-full min-w-0 bg-gray-900 p-4 sm:p-6 rounded-lg
          ...
          <ul className="text-white space-y-6">
            ...
            <li className="flex items-start gap-2 min-w-0">
              ...
              <p className="min-w-0 break-words leading-relaxed">
                ...
                , further strengthening my analytical, technical,
            ...
            <li className="flex items-start gap-2 min-w-0">
              ...
              <p className="min-w-0 break-words leading-relaxed">
                ...
                <strong>
                  PrimeCode Technologies, Chennai
                </strong>{" "}
                as an{" "}
                <strong>
                  HR Junior Executive
                ...
                while also supporting accounting and statutory
            ...
            <li className="flex items-start gap-2 min-w-0">
              ...
              <p className="min-w-0 break-words leading-relaxed">
                ...
                and continued developing my career in Human Resources.
